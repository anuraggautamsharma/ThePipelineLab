...
export default function FAQ() {
  ...
  return (
    <section id="faq" className="bg-paper px-5 py-24 md:px-8 md:py-32">
      <div className="mx-auto grid max-w-7xl gap-12 md:grid-cols-[1fr_1.6fr]">
        <div>
          <p className="eyebrow mb-4 text-violet-600">Questions</p>
          <h2 className="display text-4xl md:text-5xl">
            Before you <span className="accent-violet">ask</span>
          </h2>
              ...
              <div key={f.q} className="border-b border-line">
                ...
                <AnimatePresence initial={false}>
                  {isOpen && (
                    ...
                    >
                      <p className="max-w-2xl pb-7 text-[15px] leading-relaxed text-ink-700">
                        {f.a}
                      </p>
                    </motion.div>
                  )}
